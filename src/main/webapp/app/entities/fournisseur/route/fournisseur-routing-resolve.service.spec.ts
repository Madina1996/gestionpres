...
import fournisseurResolve from './fournisseur-routing-resolve.service';

describe('Fournisseur routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: FournisseurService;
  let resultFournisseur: IFournisseur | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IFournisseur returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        fournisseurResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultFournisseur).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IFournisseur>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
