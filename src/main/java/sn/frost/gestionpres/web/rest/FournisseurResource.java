...
/**
 * REST controller for managing {@link sn.frost.gestionpres.domain.Fournisseur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class FournisseurResource {
    ...
    public ResponseEntity<Fournisseur> partialUpdateFournisseur(
        ...
        Optional<Fournisseur> result = fournisseurRepository
            .findById(fournisseur.getId())
            .map(existingFournisseur -> {
                if (fournisseur.getPrenomNom() != null) {
                    existingFournisseur.setPrenomNom(fournisseur.getPrenomNom());
                }
                if (fournisseur.getTelephone() != null) {
                    existingFournisseur.setTelephone(fournisseur.getTelephone());
                }
                if (fournisseur.getServiceOffert() != null) {
                    existingFournisseur.setServiceOffert(fournisseur.getServiceOffert());
                }
