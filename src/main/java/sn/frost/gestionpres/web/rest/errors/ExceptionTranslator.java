package sn.frost.gestionpres.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof sn.frost.gestionpres.service.EmailAlreadyUsedException ||
            ex instanceof sn.frost.gestionpres.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof sn.frost.gestionpres.service.InvalidPasswordException
